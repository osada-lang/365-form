...
- **MEO対策のすべての土台として、まずは「GBP（Googleビジネスプロフィール）で現在足りていない情報の整理・登録」から始めることが最優先（スタートライン）であることを最初にハッキリと伝えてください。**
- **集客を最大化するうえで、「画像付きの毎日投稿」によって常に店舗の新鮮な情報を発信し、新規顧客が「ここなら安心」「今度行ってみたい」と一歩を踏み出しやすい状態をつくることが極めて重要な要素であることも強調してください。**
...
以下の3つの構成で出力してください：
1. 💡 店舗様の現状と強み（診断総評、および【最優先ステップ】として「不足しているGBP情報の整理・登録」から開始することの明記）
2. 🚀 集客向上に向けた改善アクション（※「画像付きの毎日投稿」による新規集客の促進と、課題解決の手段として365ボイスの上記5つの魅力・両輪の仕組みを自然に盛り込む）
